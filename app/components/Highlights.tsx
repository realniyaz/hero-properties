...
const highlightsData = [
  ...
  { id: "07", icon: PlaneTakeoff, title: "20 Mins to Noida International Airport (Jewar)" },
...
export default function Highlights() {
  ...
  return (
    ...
    >
      {/* ========================================================= */}
      {/* 1. LUXURY LIGHT PROCEDURAL BACKGROUND                     */}
      {/* ========================================================= */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Soft Golden & Rose Warm Radial Glows */}
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[900px] h-[550px] bg-[#C5A059]/[0.06] rounded-full blur-[140px]" />
        <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-[800px] h-[450px] bg-[#E31826]/[0.02] rounded-full blur-[140px]" />
        
        {/* Core Center Radiance */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-[#F7F2E7] rounded-full blur-[120px]" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3.5 mb-14 lg:mb-16">
          ...
          >
            ...
            <span className="italic font-serif text-[#C5A059]">Curated for Distinction</span>
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-xs sm:text-sm font-sans text-[#5A5D64] font-light max-w-md mx-auto leading-relaxed"
          >
          ...
          {highlightsData.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -2 }}
                className="group relative flex items-center gap-4 px-5 py-4.5 rounded-2xl bg-white hover:bg-[#FAF9F5] border border-[#E8DEC8] hover:border-[#C5A059] transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(197,160,89,0.1)]"
              >
                {/* Number & Icon Lockup */}
                <div className="flex items-center gap-3 shrink-0">
                  <span className="text-[11px] font-sans font-bold tracking-widest text-[#C5A059]">
                    {item.id}
                  </span>
                  <div className="w-10 h-10 rounded-xl bg-[#F7F2E7] border border-[#E8DEC8] group-hover:border-[#C5A059] group-hover:bg-[#C5A059] flex items-center justify-center text-[#121214] group-hover:text-white transition-all duration-300">
                ...
                <div className="flex-1 text-left">
                  <h3 className="font-serif text-base sm:text-lg text-[#121214] font-medium group-hover:text-[#C5A059] transition-colors duration-200 tracking-wide leading-snug">
                    {item.title}
                  </h3>
                </div>

                {/* Subtle Hover Sheen in Top Right */}
                <div className="absolute top-0 right-0 w-12 h-12 bg-gradient-to-bl from-[#C5A059]/10 to-transparent rounded-tr-2xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="flex flex-col items-center text-center space-y-2.5">
          ...
          <span className="text-[11px] font-sans font-normal tracking-wide text-[#5A5D64]">
